...
class CashSuccessWidget(QtWidgets.QWidget): #Thiết kế dưới dạng QWidget để thêm vào frame chung của màn hình chung
    ...
    def setupContentSection(self):
        ...
        self.notificationTitle.setText("Chọn thanh toán tiền mặt thành công!")
        ...
        self.instructionSubtitle.setText("Vui lòng đến quầy thanh toán tiền mặt cho nhân viên.")
        self.instructionSubtitle.setWordWrap(True)

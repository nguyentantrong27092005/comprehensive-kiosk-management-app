...
class PaymentSelection(StyleFrame):  # Change QWidget to QFrame
    def __init__(self, images, title, bg_color, border_color, parent=None):
        ...
        for img_path in images:
            ...
            label.setPixmap(pixmap.scaled(70, 70, Qt.AspectRatioMode.KeepAspectRatio))  # Scale image to fit
...
class PaymentSelectWidget(QWidget): #Thiết kế dưới dạng QWidget để thêm vào frame chung của màn hình chung
    def __init__(self):
        ...
        self.left_section = PaymentSelection(["kiosk_app/resources/images/ic_cash-coin.png", "kiosk_app/resources/images/ic_cashregister.png"], "Tiền mặt","lightblue", "navy")
        self.right_section = PaymentSelection(["kiosk_app/resources/images/ic_banktransfer.png", "kiosk_app/resources/images/ic_scanqrcode.png"], "Chuyển khoản","lightgreen", "darkgreen")

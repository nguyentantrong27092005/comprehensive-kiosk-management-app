...
class HomePageView(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.pushButtonAI.setIcon(QtGui.QIcon('admin_app/resources/images/icon_ai.png'))
        ...
        self.pushButtonAI.setIconSize(QtCore.QSize(32, 32))
        ...
        self.pushButtonAI.setMinimumSize(50, 50)

        self.layoutNavig.addWidget(self.pushButtonThucDon, 0, 0)
        self.layoutNavig.addWidget(self.pushButtonChuongTrinh, 1, 0)
        self.layoutNavig.addWidget(self.pushButtonBaoCao, 2, 0)
        self.layoutNavig.addWidget(self.pushButtonThanhToan, 3, 0)
        self.layoutNavig.addWidget(self.pushButtonAI, 4, 0)
        # 1.2.label
